...
const addTwo = (arr) => {
  // Solution code here...
  let addTwo=  arr.map(num => {return num+2;});
return addTwo
};
...
const typeNum = (arr) => {
  // Solution code here...
  let typeNum=arr.filter(num=> {return (typeof num === 'number' )});
  return typeNum;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let containsAnd=arr.filter(str=> {let n =str.includes('and'); if (n){
    return str; }
    ;});
  return containsAnd;
};
...
const oddValues = (arr) => {
  // Solution code here...
  let oddValues=arr.filter(num => {return (num % 2 !==0);});
  return oddValues;
};
